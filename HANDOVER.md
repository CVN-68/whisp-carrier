...
| 項目 | 状態（2026-09-03 時点） |
|------|----------------------|
| **ビルド済みだが未公開の exe** | **`1.0.0`。`998798a` のコード状態でビルドした 13,899,921 バイト。**[チェックリスト16項目は全部通っている](MEASUREMENTS.md#100-のビルドと配布アーカイブ2026-09-03789回目) |
| **未公開の配布アーカイブ** | `whisp-carrier-1.0.0.7z`、**1,055,056,170 バイト（1007 MiB・単一ファイル）。SHA-256 `6494C638419B76FC6A43A103C7EF3309C4F295646570850E167C09791226AC29`**。**アセット digest との照合は公開後** |
| アーカイブ内の docs | `README.md` 52,980 バイト・`THIRD-PARTY-NOTICES.md` 17,403 バイト。**どちらもソースとバイト一致** |
...
なおノイズの多い実況系では `--ff_loudnorm --ff_lowhighpass` のほうが安定する
（こちらは exe でも使える）。
